  ...
  <div class="row" id="translateForm">
    <div class="col-md-6 col-md-offset-3">
       <form id="transForm" class="well form-inline" v-on:submit="formSubmit">
        <input class="form-control" v-model="textToTranlate" type="text" placeholder="输入需要翻译的内容"/>
...
export default {
  ...
  methods: {
    formSubmit(e) {
      // alert(this.textToTranlate);
      this.$emit("formSub",this.textToTranlate,this.language);
      e.preventDefault();
    }
  },
  created(){
